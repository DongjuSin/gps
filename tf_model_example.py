...
def multi_modal_network(dim_input=27, dim_output=7, batch_size=25, network_config=None):
    ...
    nnet = TfMap.init_from_lists([nn_input, action, precision], [fc_output], [loss],
                                 conv_layer_0=[conv_layer_0], conv_layer_1=[conv_layer_1])
...
def multi_modal_network_fp(dim_input=27, dim_output=7, batch_size=25, network_config=None):
    ...
    #fc_input = tf.concat(concat_dim=1, values=[fp, state_input])   # old_version
    ...
    nnet = TfMap.init_from_lists([nn_input, action, precision], [fc_output], [loss],
                                fp=fp, conv_layer_0=[conv_layer_0], conv_layer_1=[conv_layer_1],
