...
class AlgorithmBADMM(Algorithm):
    ...
    def _update_policy(self, inner_itr):
        ...
        #fname = './policy_update/policy_update_' + str(self.iteration_count) + '.npz'
        fname = './plot_compare/label/policy_label_' + str(self.iteration_count) + '.npz'
        np.savez(fname, obs=obs_data, tgt_mu=tgt_mu, tgt_prc=tgt_prc, tgt_wt=tgt_wt)
